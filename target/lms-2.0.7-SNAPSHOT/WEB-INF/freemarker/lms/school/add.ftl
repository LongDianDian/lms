	...
	<section class="content" >
		<form class="form-horizontal" role="form">
		  <div class="form-group">
		    ...
		    <div class="col-sm-3">
		      <input type="input" class="form-control"id="schoolName"  placeholder="学校名称">
		    </div>
		  </div>
		  <div class="form-group">
		    <label  class="col-sm-1 control-label">校训</label>
		    <div class="col-sm-3">
		      <textarea rows="3" class="form-control" id="schoolMotto"  style="border-radius:0px;" placeholder="校训"></textarea>
		    </div>
		  </div>
  		  <div class="form-group">
		    ...
		    <div class="col-sm-3">
			    ...
			    <div  id="div_headPoster" style="position:relative;float: left;" >
					<img id="headPosterFile_img" src=""  width="96px" height="96px">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-3">
			    ...
			    <div  id="div_footPoster" style="position:relative;float: left;" >
					<img id="footPosterFile_img" src=""  width="96px" height="96px">
...
<script type="text/javascript" src="${ (project.staticDomain)! }/js/lms/pagejs/school/add.js">
</script>