...
function add(){
	...
	var params ={
			id:$.trim($("#schoolId").val()),
			name:schoolName,
			schoolMotto:schoolMotto,
			headPostUrl:$.trim($("#headPosterFile_img").attr("src")),
			footPostUrl:$.trim($("#footPosterFile_img").attr("src")),
			headPostUrlBase64:$.trim($("#headPosterFile_base64").val()),
			footPostUrlBase64:$.trim($("#footPosterFile_base64").val()),
	};
	$.ajax({
		url:"/lms/school/doUpdate",
