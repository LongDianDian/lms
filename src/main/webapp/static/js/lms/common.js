...
function initCalendarYM(mark)
{
	$(mark).focus(function(){
		WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM',skin:'twoer',onpicked:function(){$(this).change();},oncleared:function(){$(this).change();}});
	});
}
